...
public class Appointment {
    ...
    /**
     * Constructs an appointment focusing solely on its total per type.
     *
     * @param type for the appointment.
     * @param total Total appointments per type.
     */
    public Appointment(String type, int total) {
        this.type = type;
        this.total = total;
    }
